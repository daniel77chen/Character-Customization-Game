...
// not sure if we need this since im not using it rn 
    ...
    randomize() {
        let top_styles = [Tops.NONE, Tops.SHIRT, Tops.LONG];
        let bottom_styles = [Bottoms.NONE, Bottoms.SHORT, Bottoms.LONG];
        ...
        let skin_colors = ["#f5d990", "#ffb885", "#5e302a", "#3d3d8f"];
    ...
    make_control_panel() {
        ...
        this.new_line();
        this.key_triggered_button("None", ["Item"], () => {this.has_mic = false; this.has_cat = false; this.has_duck = false; this.has_belt = false; this.music.pause();});
