...
export class Final_Project extends Scene {
    constructor() {
        ...
        this.shapes = {
               ...
               ct: new defs.Cylindrical_Tube(60,60,[[0, 1], [0, 1]]),
               t: new defs.Torus(15, 15),
...
//         this.key_triggered_button("Attach to moon", ["Control", "m"], () => this.attached = () => this.moon);
    ...
    draw_leg(context, program_state, model_transform, t) {
        ...
        this.shapes.s.draw(context, program_state, feet, this.materials.test);
...
//         program_state.set_camera(this.attached);
        ...
        this.shapes.s.draw(context, program_state, body_transform.times(Mat4.scale(1,1,1)), this.materials.pants);
        
        let l_leg_transform = body_transform.times(Mat4.translation(-0.5,0,0));
        this.draw_leg(context, program_state, l_leg_transform, t);
